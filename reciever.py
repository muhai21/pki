...
class SEGReceiver:
    def __init__(self, private_key_path, certificate_path, ca_cert_path):
        ...
        self.sender_pub_key = None  # Will be extracted from incoming cert
...
def receive_document():
    # For testing purposes, we'll just use the sender certificate directly
    # since Flask's Werkzeug doesn't expose client cert in request.environ
    try:
        with open("segSender.crt", "rb") as f:
    ...
    try:
        ...
        # Store sender's public key for XML verification
        receiver.sender_pub_key = client_cert.public_key()
...
if __name__ == '__main__':
    ...
    context.load_cert_chain('segReceiver.crt', 'segReceiver.key')
